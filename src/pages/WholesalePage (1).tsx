...
const WholesalePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fbf7f0] font-sans">
      ...
      <section className="py-16 bg-[#f6efe4]">
        <div className="max-w-4xl mx-auto px-5">
          <div className="text-center mb-10">
            <p className="text-xs uppercase tracking-[0.25em] text-[#b8915a] mb-3">Order policy</p>
            <h2 className="font-serif text-3xl text-[#2a2018]">Simple and flexible</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl border border-[#e0d4c0] p-6 text-center shadow-sm">
              <p className="font-serif text-4xl text-[#c9a36a] mb-3">$50</p>
              <h3 className="font-serif text-lg text-[#2a2018] mb-2">First order minimum</h3>
              <p className="text-[#5b5043] text-sm leading-relaxed">
                A $50 minimum on your first order so you can explore our full range of products.
              </p>
            </div>
            <div className="bg-white rounded-2xl border border-[#e0d4c0] p-6 text-center shadow-sm">
              <p className="font-serif text-4xl text-[#c9a36a] mb-3">$0</p>
              <h3 className="font-serif text-lg text-[#2a2018] mb-2">No reorder minimum</h3>
              <p className="text-[#5b5043] text-sm leading-relaxed">
                Once you are a customer, reorder as little or as much as you need with no minimums.
              </p>
            </div>
            <div className="bg-white rounded-2xl border border-[#e0d4c0] p-6 text-center shadow-sm">
              <p className="font-serif text-4xl text-[#c9a36a] mb-3">✓</p>
              <h3 className="font-serif text-lg text-[#2a2018] mb-2">Returns on first order</h3>
              <p className="text-[#5b5043] text-sm leading-relaxed">
                Not satisfied with your first order? We accept returns so you can shop with confidence.
              </p>
            </div>
          </div>
        </div>
