                ...
                {leads.map(lead => (
                  <div key={lead.id} className="bg-white rounded-xl border border-[#e0d4c0] p-5">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-4 pt-4 border-t border-[#e0d4c0]">
                      <div>
                        <p className="text-xs text-[#9a8d78] uppercase tracking-wider mb-0.5">Event type</p>
                        <p className="text-sm text-[#2a2018] font-medium">{lead.event_type || '—'}</p>
                      </div>
                      <div>
                        <p className="text-xs text-[#9a8d78] uppercase tracking-wider mb-0.5">Event date</p>
                        <p className="text-sm text-[#2a2018] font-medium">{fmtDate(lead.event_date)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-[#9a8d78] uppercase tracking-wider mb-0.5">Location</p>
                        <p className="text-sm text-[#2a2018] font-medium">{lead.event_location || '—'}</p>
                      </div>
                      <div>
                        <p className="text-xs text-[#9a8d78] uppercase tracking-wider mb-0.5">Guests</p>
                        <p className="text-sm text-[#2a2018] font-medium">{lead.guests || '—'}</p>
                      </div>
                      <div>
                        <p className="text-xs text-[#9a8d78] uppercase tracking-wider mb-0.5">Hat style</p>
                        <p className="text-sm text-[#2a2018] font-medium">{lead.hat_style || '—'}</p>
                      </div>
                      <div>
                        <p className="text-xs text-[#9a8d78] uppercase tracking-wider mb-0.5">Company</p>
                        <p className="text-sm text-[#2a2018] font-medium">{lead.company || '—'}</p>
                      </div>
                      <div>
                        <p className="text-xs text-[#9a8d78] uppercase tracking-wider mb-0.5">Consultation date</p>
                        <p className="text-sm text-[#2a2018] font-medium">{fmtDate(lead.consultation_date)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-[#9a8d78] uppercase tracking-wider mb-0.5">Deposit</p>
                        <p className="text-sm text-[#2a2018] font-medium">{lead.deposit || '—'}</p>
                      </div>
                    </div>
                    {lead.notes && (
