            ...
            <>
              ...
              <form onSubmit={submit} className="bg-white rounded-2xl border border-[#e0d4c0] p-8 shadow-sm space-y-5">
                ...
                <div>
                  ...
                  <input required value={form.business_type} onChange={e => set('business_type', e.target.value)}
                ...
                <div>
                  ...
                  <input required value={form.tax_id} onChange={e => set('tax_id', e.target.value)}
                ...
                <div>
                  ...
                  <input ref={fileRef} type="file" accept=".pdf,.jpg,.jpeg,.png" onChange={onFilePick} className="hidden" />
                ...
                <p className="text-xs text-center text-[#8c8170]">
                  Already approved?{' '}
                  <a href="/wholesale/login" className="text-[#c9a36a] hover:underline">Log in here</a>
                </p>
              </form>
            </>
          )}
