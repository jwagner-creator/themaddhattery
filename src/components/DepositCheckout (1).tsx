...
const DepositCheckout: React.FC<DepositCheckoutProps> = ({
  ...
  const [eventLocation2, setEventLocation2] = useState(eventLocation);
   ...
   await fetch(`${EDGE_URL}/event-quote-email`, {
        ...
        body: JSON.stringify({
          lead: {
            ...
            deposit: displayDeposit ? money(displayDeposit) : money(breakdown.deposit),
            notes,
            service_addons: serviceAddons.join(', '),
            custom_addons: customAddons.join(', '),
          },
        }),
      });
    } catch {
          ...
          {status === 'done' ? (
            <div className="text-center py-6">
              ...
              <p className="text-[#5b5043] mb-6">
                ...
                a deposit link to lock in your date.
              </p>
              <a
                href={BOOKING_URL}
                target="_blank"
            ...
            <>
              ...
              <p className="text-xs text-[#8c8170] mb-5">
                We'll send you a payment link for the deposit after confirming your event details.
              </p>
              ...
              <form onSubmit={submit} className="space-y-3">
                ...
                >
                  {status === 'loading' ? 'Sending…' : 'Request & send quote'}
                </button>
              </form>
            </>
          )}
